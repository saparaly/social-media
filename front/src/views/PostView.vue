    ...
    <div class="post">
      <div class="container">
        ...
        <div class="post__container" v-if="!errorMessage">
          ...
          <div class="reaction">
            <div class="react" :class="{liked: isLiked }">
              <form action="">
            ...
            <div class="react" :class="{liked: isDisiked }">
              <form action="">
                    ...
                    <g>
                      <g>
                        <g>
                          ...
                          <path d="M332.8,324.267H179.2c-4.713,0-8.533,3.821-8.533,8.533c0,4.713,3.82,8.533,8.533,8.533h153.6     c4.713,0,8.533-3.821,8.533-8.533C341.333,328.087,337.513,324.267,332.8,324.267z"/>
                          <path d="M196.267,213.333c0-9.606-3.176-18.469-8.534-25.6H204.8c4.713,0,8.533-3.82,8.533-8.533s-3.821-8.533-8.533-8.533H102.4     c-4.713,0-8.533,3.82-8.533,8.533s3.82,8.533,8.533,8.533h17.067c-5.357,7.131-8.534,15.995-8.534,25.6     c0,23.563,19.104,42.667,42.667,42.667C177.163,256,196.267,236.896,196.267,213.333z M153.6,238.933     c-14.137,0-25.6-11.463-25.6-25.6c0-14.137,11.463-25.6,25.6-25.6c14.137,0,25.6,11.463,25.6,25.6     C179.2,227.471,167.737,238.933,153.6,238.933z"/>
                          <path d="M409.6,170.667H307.2c-4.713,0-8.533,3.82-8.533,8.533s3.82,8.533,8.533,8.533h17.067     c-5.357,7.131-8.534,15.995-8.534,25.6c0,23.563,19.104,42.667,42.667,42.667c23.563,0,42.667-19.104,42.667-42.667     c0-9.606-3.176-18.469-8.534-25.6H409.6c4.713,0,8.533-3.82,8.533-8.533S414.313,170.667,409.6,170.667z M384,213.333     c0,14.137-11.463,25.6-25.6,25.6s-25.6-11.463-25.6-25.6c0-14.137,11.463-25.6,25.6-25.6S384,199.196,384,213.333z"/>
                        </g>
                      </g>
                    </g>
                    </svg>                
  ...
  export default {
    ...
    async mounted() {
      ...
      try {
        ...
        this.isLiked = postResponse.data.isliked
        this.isDisiked = postResponse.data.isdisliked
        // for like active /************************************************************************ */
      } catch (error) {
        console.log(error); 
